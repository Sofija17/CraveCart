...
namespace CraveCart.Controllers
{
    public class FoodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,ImageUrl,Ingredients,RestaurantId")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,ImageUrl,Ingredients,RestaurantId")] Food food)
        {
            if (ModelState.IsValid)
            {
